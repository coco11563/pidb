...
import org.neo4j.values.storable.WithRecord;
...
public class PropertyCreator {
    ...
    public <P extends PrimitiveRecord> void primitiveSetProperty(
        ...
        ////NOTE: blob support, added by pidb
        if (value instanceof WithRecord)
            ((WithRecord) value).setRecord(primitiveRecordChange);
